...
IOSRenderSurfaceGL::IOSRenderSurfaceGL(fml::scoped_nsobject<CAEAGLLayer> layer, EAGLSharegroup* share_group)
    : context_(std::move(layer), share_group) {}
...
flow::ExternalViewEmbedder* IOSRenderSurfaceGL::GetExternalViewEmbedder() {
  return nullptr;
}

EAGLSharegroup* IOSRenderSurfaceGL::GetShareGroup() {
  return context_.GetShareGroup();
}
